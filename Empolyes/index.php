            ...
            <div id="navbar_main">
                ...
                <li class="nav-item dropdown">
                    <a class="dropdown-item" href="../index.php"><i
                            class="fa  fa-arrow-right text-primary"></i>Retour</a>
                </li>
            </div>
        </div>
    </nav>
    ...
    <div class="main_content" id="main-content">
        <div class="left_sidebar">
            <nav class="sidebar">
                ...
                <ul id="main-menu" class="metismenu">
                    ...
                    <li class="active"><a href="./index.php"><i class="fa fa-user"></i><span>Employés</span></a></li>
        ...
        <div class="page">
            <nav class="navbar navbar-expand-lg navbar-light bg-light">
                <a class="navbar-brand" href="javascript:void(0);">L'absence des employés</a>
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                </div>
                <form class="form-inline my-2 my-lg-0">
                    <a href="./add.php" title="Ajouter" class="btn btn-success ml-2">Ajouter un employe</a>
                </form>
            </nav>
                            ...
                            <div class="body">
                                <div class="table-responsive">
                                    <table class="table table-striped table-hover js-basic-example dataTable">
                                        ...
                                        <tbody>
                                            <?php
                                            $sql = $db->prepare('SELECT * FROM employes');
                                            $sql->execute();
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="action-list ">
                                                        <!-- <li> -->
                                                        <a href="update.php?id=<?= $result[0] ?>"
                                                            class="btn btn-primary">
                                                            <i class="fa fa-edit">
                                                            </i>
                                                        </a>
                                                        <!-- </li>
                                                    <li>--><a href="delete.php?id=<?= $result[0] ?>"
