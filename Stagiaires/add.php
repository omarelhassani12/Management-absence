...
<?php 
    if(isset($_POST['valider'])){
        ...
        $req = $db->prepare("INSERT INTO stagiaires(cin,nom,prenom,date_debut,nombre_absence)
    ...
    <div class="main_content" id="main-content">
        <div class="left_sidebar">
            <nav class="sidebar">
                <ul id="main-menu" class="metismenu">
                    ...
                    <li><a href="../Empolyes/add.php"><i class="fa fa-plus-circle"></i><span>Ajouter un employe</span></a></li>
                    <li class="active"><a href="./add.php"><i class="fa fa-plus-circle"></i><span>Ajouter un stagiaire</span></a></li>
                </ul>
            </nav>
        </div>
        ...
        <div class="page">
            <nav class="navbar navbar-expand-lg navbar-light bg-light">
                <a class="navbar-brand" href="javascript:void(0);">Ajouter un stagiaire</a>
            </nav>
            <div class="container-fluid">
                <div class="row clearfix">
                    <div class="col-lg-12 col-md-12">
                        <div class="card">
                            <div class="header">
                                <h2>entre les informations de stagiaire</h2>
                            </div>
                            <div class="body">
